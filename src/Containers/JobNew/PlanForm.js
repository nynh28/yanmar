...
import { setSchemaPlan } from './Form/schema.js'
...
import {
  GoogleMap, LoadScriptNext, Marker, Polyline, Autocomplete, DirectionsService, DirectionsRenderer
...
class PlanForm extends Component {
  ...
  render() {
    let { formData, typeWorkList, typeTripList, deliveryDayList, typeVehicleList, pathList, stationList } = this.state
    ...
    return (
      <Row>
        <Col lg="6">
          <PannelBox title={'Plan'}>
            <Form
              className="title-form"
              schema={
                setSchemaPlan(typeWorkList, typeTripList, deliveryDayList, typeVehicleList, pathList, stationList)
              }
              uiSchema={uiSchema}
              fields={fields}
              formData={formData}

  ...
  return (
    <svg>
      ...
      <text textAnchor="middle" x="100" y="90" style={{ fontSize: 18, fill: '#494949', fontFamily: 'Prompt' }}>
        <tspan style={{ fontSize: 20, fill: '#494949', fontFamily: 'Prompt' }} x="100"> Total</tspan>
        <tspan x="100" dy="20px" style={{ fontWeight: 600, fontFamily: 'Prompt' }}>{
          calculateTotal(pieChart)
        }</tspan>
        <tspan style={{ fontSize: 14, fill: '#494949', fontFamily: 'Prompt' }} dy="20px" x="100"> Units</tspan>
      </text>

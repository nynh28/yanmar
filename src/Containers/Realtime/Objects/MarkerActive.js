...
class MarkerActive extends Component {
  ...
  render() {
    ...
    let _licenseplate = get(information, 'info.vehicle_name')
    if (_licenseplate == "") _licenseplate = get(information, 'info.licenseplate')
    if (_licenseplate == "") _licenseplate = get(information, 'info.vin_no')
    ...
    >
      ...
      >
        <div style={{ padding: 5 }}>
          ...
          {/* <span style={{ backgroundColor: 'white', opacity: 0.75, padding: 5 }}><b>{information.info.licenseplate.replace("-", "‑")}</b></span> */}

...
import ControlRoomActions from '../../../Redux/ControlRoomDealerRedux'
...
class Geofences extends Component {
  ...
  async getGeofenceDetail(id) {
    ...
    this.props.setStatesContorlRoomDealerRedux({ geofenceDetail: data })
...
const mapStateToProps = (state) => ({
  ...
  geofenceDetail: state.controlroomdealer.geofenceDetail,
  language: state.versatile.language
});
const mapDispatchToProps = (dispatch) => ({
  setStatesContorlRoomDealerRedux: (obj) => dispatch(ControlRoomActions.setStatesContorlRoomDealerRedux(obj)),
});

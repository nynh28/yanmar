...
class OverlayPanel extends Component {
  ...
  onRowPrepared = (props) => {
    ...
    if (!isEmpty(information) && key === get(information, "info.vid")) {
  ...
  render() {
    ...
    let { initialVehiclesDataSI, information, select, displayVehicle } =
      this.props;
          ...
          {isEmpty(initialVehiclesDataSI) ? (
            ...
            >
              ...
              >
                ...
                <Column dataField="vin_no" width={220} caption={""} />
                <Column
                  dataField="dealer_id"
                  width={0}
                  groupIndex={0}
  ...
  renderer = (props, id, name) => {
    ...
    if (id === "dealer_id" && value === null) {
      ...
      let vl = this.props.initialVehiclesDataSI.find(
        (item) => get(item, "dealer_id") === value
      );
      groupText = get(vl, "dealer_name");
    }
...
const mapDispatchToProps = (dispatch) => ({
  ...
  setStateReduxRealtime: (obj) =>
    dispatch(RealtimeNewActions.setStateReduxRealtime(obj)),
});

        ...
        <Col lg={5} >
          <BoxContrainer boxContentStyles={{ minHeight: 506 }}  >
            <Tabbed
              ...
              tabPosition={'top'}
              tabName={[<span><img src="../icons/Excavator.svg" style={{ paddingRight: 4 }} />{t("realtime_176")}</span>,
              <span><i className="fas fa-tools" aria-hidden="true" style={{ paddingRight: 4 }}></i>{t("realtime_177")}</span>]}
              tabPane={[
                // Driving Behavior

...
class OverlayPanelNew extends React.Component {
  ...
  render() {
    let { activeTabOverlay, hideOverlayPanel, initialVehiclesData, isLoading } = this.props
        ...
        <div className="box-overlay-panel-realtime">
          ...
          <div style={{ height: '100%', paddingTop: 0 /*165*/ }}>
            <div style={{
              ...
              onClick={() => this.props.setStateReduxRealtime({ hideOverlayPanel: !hideOverlayPanel })}
            >
              <center><i className={"fa " + (hideOverlayPanel ? "fa-chevron-left" : "fa-chevron-right")}></i></center>
            </div>
          </div>

          <div className="tabs-container detail-overlay-realtime"
            id={"overlay-panel-colaps"} style={{
            ...
            <Tabbed
              ...
              tabName={[
                <span><img src="../icons/Excavator.svg" /></span>,
              ]}
              tabPane={[
                <VehicleList

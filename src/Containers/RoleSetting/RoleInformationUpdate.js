...
class RoleInformationUpdate extends Component {
    ...
    render() {
        ...
        console.log('--------------- New Role Information Update Screen -------------------')
        return (
            <div>
...
export default connect(mapStateToProps, mapDispatchToProps)(RoleInformationUpdate)

...
class Geofences extends Component {
  ...
  markerLoadHandler(anchor, id) {
    ...
    this.props.getGeofenceDetailSum(id)
...
const mapStateToProps = (state) => ({
  geofenceByTypes: state.summary.geofenceByTypes,
});
const mapDispatchToProps = (dispatch) => ({
  getGeofenceDetailSum: (geofenceId) => dispatch(SummaryActions.getGeofenceDetailSum(geofenceId))
});

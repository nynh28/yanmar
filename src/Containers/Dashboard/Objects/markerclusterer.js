...
ClusterIcon.prototype.triggerClusterMouseover = function (event) {
    ...
    window.google.maps.event.trigger(markerClusterer, 'clustermouseover', this.cluster_, event);
...
ClusterIcon.prototype.triggerClusterMouseout = function (event) {
    ...
    window.google.maps.event.trigger(markerClusterer, 'clustermouseout', this.cluster_, event);
...
function defaultClusterOnAdd(clusterIcon) {
    ...
    window.google.maps.event.addDomListener(clusterIcon.div_, 'click', function (event) {
    ...
    window.google.maps.event.addDomListener(clusterIcon.div_, 'mousedown', function () {
        isDragging = false;
        isMouseDown = true;
    });

    window.google.maps.event.addDomListener(clusterIcon.div_, 'mouseup', function () {
        isDragging = false;
        isMouseDown = false;
    });

    window.google.maps.event.addDomListener(clusterIcon.div_, 'mousemove', function () {
        if (isMouseDown) {
            isDragging = true;
        }
    });

    window.google.maps.event.addDomListener(clusterIcon.div_, 'mouseover', function (event) {
        clusterIcon.triggerClusterMouseover(event);
    });

    window.google.maps.event.addDomListener(clusterIcon.div_, 'mouseout', function (event) {

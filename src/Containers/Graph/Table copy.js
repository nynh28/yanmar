...
class Table extends React.Component {
  ...
  zoomDataGrid() {
    ...
    switch (level) {
      case 1:
        level = 2
        document.getElementById('gridReportTable').style.zoom = 1.3
        break;
      case 2:
        level = 3
        document.getElementById('gridReportTable').style.zoom = 1.6
        break;
      default:
        level = 1
        document.getElementById('gridReportTable').style.zoom = 1
        break;
    }
            ...
            <div className="panel-body">
              ...
              <div className="row">
                <div className="col-md-12 text-right">
                  <div className="form-group">
                    {/* <a href={'#/reportEcotree'}><button style={{ width: "150px" }} className="btn btn-primary"><i className="fa fa-cogs"></i> Full Report</button></a> */}
                    <a href={'#/reportEcotree'}><button className="btn btn-primary"><i className="fa fa-cogs"></i> Full Report</button></a>
                  </div>
                </div>
              </div>
              <DataGrid

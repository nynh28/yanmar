...
class ModalVideo extends Component {
  ...
  intervalReload() {
    ...
    for (let idx in listVideo) {
      ...
      if (get(listVideo[idx], 'channel')) {
        ...
        if (get(this, '[ref_' + listVideo[idx].channel + '].player.player.flv')) {
          ...
          if (!this['ref_' + listVideo[idx].channel].player.player.flv._receivedCanPlay) {
            // console.log(">>>>> RELOAD")
      ...
      if (listVideo !== null && nextProps.listVideo !== null) {
        for (let i in nextProps.listVideo) {
          if (diff(nextProps.listVideo[i], listVideo[i])) {
            if (get(this, '[ref_' + listVideo[i].channel + '].player.player.flv')) {
              console.log('UNLOADDDDDDDDDDDDDDDD!!!!!!!!!!!!!!!')
              get(this, '[ref_' + listVideo[i].channel + '].player.player.flv').unload()
            }
            break
          }
        }
  ...
  mapChannel(data) {
    let _data = [...data], channelCount = data.length
      ...
      <div
        ...
        <strong>
          <div className="ibox-title">
            <div className="icon-hover" style={{ float: 'right' }} onClick={() => this.props.setIsShowModalVideo(false)}>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  setIsShowModalVideo: (bln) => dispatch(RealtimeNewActions.setIsShowModalVideo(bln)),

...
class Geofences extends Component {
  ...
  setObjectData(geofenceByTypes) {
    ...
    // console.log('poly', this.polylines, this.polygons)
    this.props.setListIconGeof(this.listGeof)
    // this.props.setListIconGeof([...this.markers, ...this.markerPolylines, ...this.markerPolygons], [...this.polylines, ...this.polygons])
  }
  ...
  createGeoPoint(data) {
    ...
    this.listGeof.push({ position: get(data, 'coordinates[0]', {}), point: marker })
  ...
  createGeoLine(data) {
    ...
    this.listGeof.push({ position: get(data, 'iconPoint', {}), point: marker, polyline: polyLine })
  ...
  createGeoPolygon(data) {
    ...
    this.listGeof.push({ position: get(data, 'iconPoint', {}), point: marker, polygon: bermudaTriangle })
  ...
  setTitleInfoWindow(language) {
    ...
    this.geofenceId !== null && this.props.getGeofenceDetail(this.geofenceId)
  }
...
const mapStateToProps = (state) => ({
  geofenceByTypes: state.realtimeNew.geofenceByTypes,

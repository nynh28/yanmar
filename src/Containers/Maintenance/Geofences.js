...
class Geofences extends Component {
  ...
  shouldComponentUpdate(nextProps) {
    ...
    if (geofenceDetail !== nextProps.geofenceDetail) {
      let dt = nextProps.geofenceDetail
      $("#lb_geofenceType").text(get(dt, 'geofenceTypeNav.value'))
      $("#lb_geofenceName").text(get(dt, 'name'))
      $("#lb_geofenceDescription").text(get(dt, 'description'))
      $("#lb_subdistrict").text(get(dt, 'locationSimpleInfo.subdistrict'))
      $("#lb_district").text(get(dt, 'locationSimpleInfo.district'))
      $("#lb_province").text(get(dt, 'locationSimpleInfo.province'))
      $("#lb_hazard").text(get(dt, 'isHazard') ? 'Yes' : 'No')
      $("#lb_share").text(get(dt, 'isShare') ? 'Yes' : 'No')
      $("#lb_geometryType").text(get(dt, 'geomTypeNav.value'))
    }
  ...
  async getGeofenceDetail(id) {
    ...
    if (!isEqual(response))
      this.props.setValue("geofenceDetail", response)
    else
      this.props.setValue("geofenceDetail", [])
  }
...
const mapStateToProps = (state) => ({
  ...
  geofenceByTypes: state.maintenance.geofenceByTypes,
  geofenceDetail: state.maintenance.geofenceDetail
});

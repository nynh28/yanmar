...
const PreviewImportRegistration = () => {
    ...
    const handleImport = () => {
        ...
        fetch('https://yanmar-api.veconnect.vn/prod/fleet/setting/import_registration', {
            method: 'POST',
            body: formData,
            // headers: {
    ...
    const handleChange = (event) => {
        ...
        if (file) {
            ...
            setUploading(true);
            // You can use any AJAX library you like
            fetch('https://yanmar-api.veconnect.vn/prod/fleet/setting/Registration/read_file_import', {
                method: 'POST',
                body: formData,
                // headers: {
                //   authorization: 'Bearer '
    ...
    const columns = [
        ...
        {
            title: 'Purchases Type',
            className: 'text-[14px] whitespace-nowrap',
            ...getColumnSearchProps('purchases_type'),
            dataIndex: 'purchases_type',
        },
        {
            title: 'Leased No',
            className: 'text-[14px] whitespace-nowrap',
            ...getColumnSearchProps('leased_no'),
            dataIndex: 'leased_no',
        },
        {
            title: 'Delivery Date',
                ...
                <div className='content-header'>
                    <div className="flex flex-row space-x-3">
                        ...
                        <div className="text-end">
                            <button onClick={() => {
                                handleDownloadTemplate(process.env.PUBLIC_URL + '/template/registration.xlsx', 'Registration Template Import')
...
export default PreviewImportRegistration

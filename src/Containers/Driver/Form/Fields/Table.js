...
const DataGridTrans = (arg) => {
    ...
    return (
        <DataGrid
            ...
            onEditingStart={arg.onRowEditing}
        >
...
class Table extends Component {
    constructor(props) {
        ...
        this.onRowEditing = this.onRowEditing.bind(this);
    }
    onToolbarPreparing(e) {
        ...
        this.props.btnForm && btnCustom.push(btnForm)
        e.toolbarOptions.items.unshift(...btnCustom);
    }
    ...
    render() {
        ...
        return <Suspense fallback={"loading"}>
            <DataGridTrans
                ...
                onRowEditing={this.onRowEditing}

            ...
            <div className="ibox float-e-margins">
              <div className="ibox-content" style={{ paddingLeft: 35, paddingRight: 35, borderWidth: ' 4px 0px 0px ', borderColor: '#e7eaec' }}>
                ...
                <Row>
                  <TableRole
                    mode={"api"}
                    serversideSource={ENDPOINT_BASE_URL.concat('/grid-view/model-class-type?' + params)}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ClassType))

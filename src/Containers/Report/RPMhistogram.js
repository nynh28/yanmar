...
import './table.css';
import Barcom3 from "./Graph/RPMReportCharts/Barcomponent3";
import Barcom2 from "./Graph/RPMReportCharts/Barcomponent2";
import Barcom1 from "./Graph/RPMReportCharts/Barcomponent1";
            ...
            <div className="ibox-content">
              ...
              <div className="row">
                <div className="col-md-8">
                  <Barcom1 chartwidth={300} chartHeight={300}></Barcom1>
                ...
                <div className="col-md-3">
                  ...
                  <br></br>
                  <br></br>
                  <h3 class="text-center">Max RPM : 2100 RPM</h3>
                  <h3 class="text-center">Over RPM Count : 1 Time </h3>
                  <h3 class="text-center">Over RPM Time : 00:33:22 Time</h3>
                </div>
              </div>
              <br></br>
              <div className="row">
                <div className="col-md-6">
                  ...
                  <Barcom2 ></Barcom2>
                  <h3 class="text-center">Max RPM = 1400 RPM</h3>
                </div>
                <div className="col-md-6">
                  <h3>Hight Speed Area</h3>
                  <Barcom3></Barcom3>
                  <h3 class="text-center" >Max RPM = 2000 RPM</h3>
                </div>
              </div>

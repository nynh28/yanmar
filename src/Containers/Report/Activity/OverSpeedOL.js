...
class OverSpeedOL extends React.Component {
  constructor(props) {
    super(props)
  ...
  async loaddataOver() {
    ...
    //console.log(cust_id)
    var api = ENDPOINT_BASE_URL + "fleet/report/overspeed"
    var object = {
  ...
  async loaddatadetail(id) {
    var api = ENDPOINT_BASE_URL + "fleet/report/overspeed/" + id
    var start_date = this.props.startDate
    var start_date_y = start_date.split('/')[0]
    var start_date_m = start_date.split('/')[1]
    var start_date_d = start_date.split('/')[2]
              ...
              <div className="col-lg-12">
                <div className="ibox ">
                  ...
                  <div className="ibox-content">
                    ...
                    <Table
                      dataSource={this.state.dataOver}
                      mode={"offline"}
                      table_id={4}
...
export default (connect(mapStateToProps, mapDispatchToProps)(OverSpeedOL))

...
class Reportpromotionhistory extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
        ...
        this.store = new CustomStore({
            ...
            load: (loadOptions) => {
                ...
                //console.log(params);
                return fetch(`https://hino-dev-api.natapol.work/api/Reportpromotion${params}`)
                    .then(handleErrors)
                ...
                <div className="col-md-12">
                    <div className="ibox float-e-margins">
                        <div className="ibox-title">
                            <h5>Report Promotion history</h5>
...
export default Reportpromotionhistory;
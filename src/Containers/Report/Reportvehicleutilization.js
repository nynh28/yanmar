...
class ReportUtilization extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
    ...
    this.store = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        //console.log(params);
        return fetch(`https://hino-dev-api.natapol.work/api/Utilization${params}`)
          .then(handleErrors)
  ...
  zoomDataGrid() {
    ...
    switch (level) {
      case 1:
        level = 2
        document.getElementById('gridUtilization').style.zoom = 1.3
        break;
      case 2:
        level = 3
        document.getElementById('gridUtilization').style.zoom = 1.6
        break;
      default:
        level = 1
        document.getElementById('gridUtilization').style.zoom = 1
        break;
    }
...
export default ReportUtilization;

...
import DataGrid, { Column, Selection, Export, ColumnChooser, SearchPanel, Paging, Pager, Grouping, GroupPanel, Summary, GroupItem, FilterRow, HeaderFilter, rowAlternationEnabled } from 'devextreme-react/data-grid';
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          >
            ...
            <Export enabled={false} fileName="Employees" allowExportSelectedData={true} />
            ...
            <Grouping visible={false} autoExpandAll={false} />

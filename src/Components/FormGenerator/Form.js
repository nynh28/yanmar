...
import DropdownBinding from "./DropdownBinding/DropdownBinding";
    ...
    for (let propsName in item.properties) {
      ...
      let fieldGroup = (
        <Col lg={gridColumnSize} className="form-column">
          ...
          <FormGroup>
            <Label className="control-label" style={{ fontWeight: 500, marginRight: 5 }}>{title}{item.properties[propsName].required && <span style={{ color: 'red' }}>*</span>} :</Label>
            {/* <Col lg={8}  > */}
                        ...
                        /> :
                          ...
                          /> :
                            ...
                            /> :
                              ...
                              /> : fieldType == "DropdownBinding" ? <DropdownBinding
                                id={propsName}
                                value={item.properties[propsName].value}
                                optionGroup={item.properties[propsName].optionGroup}
                                placeholder={item.properties[propsName].placeholder}
                              /> : ""
            }
            {/* <div>

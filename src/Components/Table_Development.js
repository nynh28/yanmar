    ...
    return (
      <div className="row">
        <div className="col-md-12">
          <div style={this.state.setting_profile.length == 0 ? { display: 'none' } : {}} className="row">
            <div className="col-lg-12 text-left">
              <div className="form-inline float-right" style={{ marginBottom: 15 }}>
                ...
                <div className="form-group">
                  <button style={{ marginLeft: 15, borderColor: '#1ab394' }} onClick={() => window.jQuery('#setting-modal').modal('show')} className="btn btn-default">Add Setting</button>
                </div>
                <div className="form-group">
                  <button style={{ marginLeft: 15, borderColor: 'red' }} onClick={this.deleteProfileSetting} className="btn btn-default">Delete Setting</button>
                </div>
              </div>
            </div>
            <hr></hr>
          ...
          <button onClick={() => { console.log(JSON.stringify(this.datagrids.current.instance.state())) }} className="btn btn-info">getState</button>
          <div id="setting-modal" className="modal fade" role="dialog">
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 className="modal-title">Add Table Setting</h4>
                </div>
                ...
                <div className="modal-footer">
                  <button type="button" className="btn btn-primary" onClick={this.saveProfileSetting} >Submit</button>
                </div>
              </div>
            </div>
          </div>

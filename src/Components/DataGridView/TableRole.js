...
import DataGrid, {
  ...
  Pager, Grouping, GroupPanel, Summary, GroupItem, FilterRow, HeaderFilter, TotalItem
...
class TableRole extends React.Component {
  ...
  async load_setting_profile(forceselected = false) {
    ...
    var responseJson = await response.json();
    if (responseJson.result == true) {
        console.log(responseJson.setting)
  ...
  render() {
    ...
    console.log("this.datagrids : ", this.datagrids)
          ...
          <div style={this.state.setting_profile.length == 0 ? { display: 'none' } : {}} className="row">
            ...
            <div className="col-lg-12 text-left">
              ...
              <div className="form-inline float-right" style={{ marginBottom: 15 }}>
                ...
                <div className="form-group">
                  <button style={{ marginLeft: 15, }} onClick={() => window.jQuery('#setting-modal').modal('show')} className="btn btn-success">{t("save")} </button>
                </div>
                <div className="form-group">
                  <button style={{ marginLeft: 15, }} onClick={this.deleteProfileSetting} className="btn btn-danger">{t("delete")}</button>
                </div>
              </div>
            </div>
          </div>

...
class Table extends React.Component {
  ...
  cellRender1(data) {
    return (<div> {(data.value).toFixed(2)}  KM</div>)
  }

  cellRender2(data) {
    return (<div> {(data.value / 3600).toFixed(0)}  Hours</div>)
  }

  cellRender3(data) {
    return (<div> {(data.value).toFixed(2)} Points</div>)
  }

  // cellRender4(data) {
  //   var item = []
  //   Object.keys(data.value).forEach(function (i) {
  //     item.push(data.value[i])
  //   })
  //   return (<div>
  //     {item.map((element, i) => {
    ...
    return (
      <div className="row">
        <div className="col-md-12">
          ...
          >
            <Column dataField="driver" caption="Rank" cellRender={(data) => {
              return (<div>{(data.rowIndex + 1)} </div>)
            }}></Column>
            <Column dataField="driver"></Column>
            <Column dataField="mileage" cellRender={this.cellRender1}></Column>
            <Column dataField="driving_time" cellRender={this.cellRender2}></Column>
            <Column dataField="behavior_score" cellRender={this.cellRender3}></Column>
            {/* <Column dataField="behavior" cellRender={this.cellRender4}></Column> */}

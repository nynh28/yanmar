...
const LV_SUB_EVENT = [31, 32, 41, 42, 43];
const EVENT_DEALER_ALERT = [10000, 10004, 10005, 10001, 10006];
const EVENT_CUS_ALERT = [
  10001, 10008, 11000, 11001, 3002, 1008, 20004, 20002, 20003,
];
    ...
    TOPIC_EVERT = PubSub.subscribe(topics).subscribe({
      ...
      next: (data) => {
        ...
        if ([31, 32].includes(this.props.dataLogin.userLevelId)) {
          ...
          [41, 42, 43].includes(this.props.dataLogin.userLevelId) &&
          EVENT_CUS_ALERT.includes(data.value.event_id)
        ) {
          this.props.setToastEvent(data.value);
        }
      },
              ...
              <li className={this.state.languagebox} id="language-li">
                ...
                <ul className="dropdown-menu dropdown-alerts">
                  ...
                  <LiLanguage
                    ...
                    language="ja"
                    name="Japanese"
                    onClick={() => this.props.setLanguage("ja")}
                  />
                </ul>
              </li>
            </Suspense>
